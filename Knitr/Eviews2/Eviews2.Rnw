...
<<Normal, fig.height=5, echo=FALSE, fig.cap="Normal Distribution">>=
x <- rnorm(100000, 0, 0.1925)
hist(x, main = "Distribution of a random variable with zero mean and SE = 0.1925", prob = TRUE)
